...
export {}
declare global {
  const DEFAULT_COMPANY_PROFILE: typeof import('../../utils/empresaData').DEFAULT_COMPANY_PROFILE
  const IMMERSION_ITEMS: typeof import('../../utils/empresaData').IMMERSION_ITEMS
  const INITIAL_CANDIDATES: typeof import('../../utils/empresaData').INITIAL_CANDIDATES
  const INITIAL_CHALLENGES: typeof import('../../utils/empresaData').INITIAL_CHALLENGES
  const INITIAL_EVALUATIONS: typeof import('../../utils/empresaData').INITIAL_EVALUATIONS
  const MENTORS: typeof import('../../utils/empresaData').MENTORS
...
declare module 'vue' {
  interface ComponentCustomProperties {
    readonly DEFAULT_COMPANY_PROFILE: UnwrapRef<typeof import('../../utils/empresaData')['DEFAULT_COMPANY_PROFILE']>
    readonly IMMERSION_ITEMS: UnwrapRef<typeof import('../../utils/empresaData')['IMMERSION_ITEMS']>
    readonly INITIAL_CANDIDATES: UnwrapRef<typeof import('../../utils/empresaData')['INITIAL_CANDIDATES']>
    readonly INITIAL_CHALLENGES: UnwrapRef<typeof import('../../utils/empresaData')['INITIAL_CHALLENGES']>
    readonly INITIAL_EVALUATIONS: UnwrapRef<typeof import('../../utils/empresaData')['INITIAL_EVALUATIONS']>
    readonly MENTORS: UnwrapRef<typeof import('../../utils/empresaData')['MENTORS']>
